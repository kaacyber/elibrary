...
class All_setting extends CI_Controller
{
    ...
    function index()
    {        
        $meta['judul']="Skala Kategorisasi Keseluruhan";
        $this->load->view('tema/header',$meta);
        $dKriteria['data']=$this->m_db->get_data('conf_kriteria',array('id !='=>''),'id ASC');
		
    	$this->load->view(akses().'/kriteria/matrikall',$dKriteria);
    ...
    function getdetail()
    {
		...
		$output=array();
        $dKriteria['data']=$this->m_db->get_data('conf_kriteria',array('id ='=>$id),'id ASC');
		
    	$this->load->view(akses().'/kriteria/matrikutama',$dKriteria);
    }
