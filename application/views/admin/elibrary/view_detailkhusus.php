...
<div class="form-group required">
    ...
    <div class="col-md-6">
      <input readonly="true" type="text" name="jenis" id="" class="form-control " required="" autocomplete="" placeholder="Jenis Laporan" value="<?=$row->jenis;?>"/>  
    </div>
</div>
<div class="form-group required">
    <label class="col-sm-2 control-label" for="">Judul Laporan</label>
    <div class="col-md-6">
        <input readonly="true" type="text" name="judul" id="" class="form-control " required="" autocomplete="" placeholder="Judul Laporan" value="<?=$row->judul;?>"/>        
    </div>
</div>
<div class="form-group required">
    <label class="col-sm-2 control-label" for="">File</label>
    <div class="col-md-6">
        <input readonly="true" type="text" name="file" id="" class="form-control " required="" autocomplete="" placeholder="File" value="<?=$row->file;?>"/>     
    </div>
</div>
<div class="form-group required">
