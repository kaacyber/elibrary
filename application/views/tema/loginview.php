...
<html>
  ...
  <body class="hold-transition login-page" style="background-image: url(<?php echo base_url(); ?>img/bg.jpg); background-size:cover; ">
    <div class="login-box">
      <div class="login-logo">
        <!--<img src="<?=base_url();?>img/logo.png" widht="200" height="200">-->
        <a href="<?=base_url();?>" style="color: white;"><b>E-</b>Library</a>
      </div><!-- /.login-logo -->
